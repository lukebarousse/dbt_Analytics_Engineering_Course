...
| `3.07/fct_job_postings.sql` | 3.07 Fact Table | Compiles with 0 QUALIFY / is_incremental / ROW_NUMBER (the four features 3.09 and 3.12 add later) |
...
| `lukeb.co/dbt-fct` | `fct_job_postings.sql` | **frozen** (3.09 adds QUALIFY, 3.12 adds incremental) |
